...
Note: The geographic resolution of the input raster has a major impact on the results.
...
## b) Line and Polygon Rasterization
...
Note: Using a custom template raster is a also a great way to explore how the resolution impacts the results of rasterization!
...
```{r}
#create a data frame with the Landsat-7 bands and wavelengths
landsat_bands <- data.frame(
  Band = c("Band 1", "Band 2", "Band 3", "Band 4", "Band 5", "Band 7"),
  Wavelengths = c(
...
kable(landsat_bands, col.names = c("Band", "Wavelengths"), caption = "Landsat-7 Bands and Wavelengths")
...
-   Near infrared (red channel), red (green channel), green (blue channel):
    -   Plants reflect near infrared and green light, while absorbing red - Plants appear deep red and therefore helpful for gauging plant health
